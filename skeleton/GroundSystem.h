...
{
public:
    GroundSystem(const Ground_Data& pd, int n, const physx::PxFilterData& dt = physx::PxFilterData(0,0,0,0), const physx::PxVec3& mt= physx::PxVec3(0.0), bool _trigger = false);
    void init() override;
